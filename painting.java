...
public class painting extends JPanel implements MouseListener {
    ...
    private static Texture texState(String string) {
        String filename = "images/" + string + ".jpeg";
    ...
    public static BranchGroup createScene() {
        ...
        addLights(scene, CommonsNP.White);
    ...
    public painting(BranchGroup sceneBG) {
        ...
        CommonsNP.setEye(new Point3d(2, 2, 6.0));
        CommonsNP.defineViewer(su); // set the viewer's location
