...
public class CommonsJJ extends JPanel {
	...
	public final static Color3f None = new Color3f(0.0f, 0.0f, 0.0f);
	...
	public CommonsJJ(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new CommonsJJ(createScene()));    
	}
	...
	public static class MyGUI extends JFrame {
		...
		public MyGUI(BranchGroup branchGroup, String title) {
			...
			frame.getContentPane().add(new CommonsJJ(branchGroup));
			pack();
		}		
	}
}
