...
public class DoorIndicator extends JPanel {
	...
	private static Sphere jupiter = createSphere(0.25f, 80, CommonsEK.Orange, "galaxy.jpg");
	private static Sphere moon = createSphere(0.25f, 80, CommonsEK.Green, "galaxy.jpg");
	private static Sphere neptune = createSphere(0.25f, 80, CommonsEK.Orange, "galaxy.jpg");
	...
	private static Box doorBlock() {
		...
		Appearance app = setAppearance(CommonsEK.White, CommonsEK.Blue, "doorStone.jpg");
	...
	private static TransformGroup keyHole() { 
		...
		Appearance app = setAppearance(CommonsEK.White, CommonsEK.Blue, "keyHole.png");
